...
namespace App\Libraries\Shortcode\View;

use ArrayAccess;
use Illuminate\Contracts\Support\Renderable;
use Illuminate\View\View as IlluminateView;
use App\Libraries\Shortcode\Compilers\ShortcodeCompiler;
...
class View extends IlluminateView implements ArrayAccess, Renderable
{
     ...
     *
     * @var \App\Libraries\Shortcode\Compilers\ShortcodeCompiler
     */
    public $shortcode;
     ...
     * @param string $path
     * @param array $data
     * @param \App\Libraries\Shortcode\Compilers\ShortcodeCompiler $shortcode
     */
